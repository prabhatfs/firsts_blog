...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'theme_siteconfiguration', (
            ...
            ('col1_heading', self.gf('django.db.models.fields.CharField')(default='About us', max_length=200)),
            ('col1_content', self.gf('mezzanine.core.fields.RichTextField')()),
            ('col2_heading', self.gf('django.db.models.fields.CharField')(default='Useful links', max_length=200)),
            ('col3_heading', self.gf('django.db.models.fields.CharField')(default='Follow us on Twitter', max_length=200)),
            ('col3_widget', self.gf('django.db.models.fields.TextField')()),
            ('col4_heading', self.gf('django.db.models.fields.CharField')(default='From the Blog', max_length=200)),
        ))
    ...
    models = {
        ...
        u'theme.siteconfiguration': {
            ...
            'col1_heading': ('django.db.models.fields.CharField', [], {'default': "'About us'", 'max_length': '200'}),
            'col2_heading': ('django.db.models.fields.CharField', [], {'default': "'Useful links'", 'max_length': '200'}),
            'col3_heading': ('django.db.models.fields.CharField', [], {'default': "'Follow us on Twitter'", 'max_length': '200'}),
            'col3_widget': ('django.db.models.fields.TextField', [], {}),
            'col4_heading': ('django.db.models.fields.CharField', [], {'default': "'From the Blog'", 'max_length': '200'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'site': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['sites.Site']"})
        },
        u'theme.slide': {
