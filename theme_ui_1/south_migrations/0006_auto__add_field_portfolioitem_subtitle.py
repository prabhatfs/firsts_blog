...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PortfolioItem.subtitle'
        db.add_column(u'theme_portfolioitem', 'subtitle',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=200, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PortfolioItem.subtitle'
        db.delete_column(u'theme_portfolioitem', 'subtitle')
